...
<div class="my-2">
    <div class="d-flex justify-content-start">
        ...
        <a href="/portal/chat?hash=<?php echo $chat["chat_hash"]; ?>" class="text-decoration-none <?php echo $modeTheme; ?>"> <span class="fa fa-comment-o"></span> Chat <span class="small-font">(<?php echo $messagesCount; ?>)</span></a> &nbsp;
        <a class="mx-2 text-decoration-none <?php echo $modeTheme; ?>" href="/portal/files?project=<?php echo $project['project_id']; ?>"><span class="fa fa-files-o"></span> Docs <span class="small-font">(<?php echo count($docs); ?>)</span></a> &nbsp;
